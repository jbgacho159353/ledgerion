  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="glass-card w-full max-w-md animate-fade-up p-8">
        ...
        <h1 className="mt-4 text-center font-sans text-2xl font-semibold text-white">Create your account</h1>
        <p className="mt-1 text-sm text-slate-400">
          Starts with a $10,000 demo balance and 1% risk per trade — adjust anytime in Settings.
        </p>
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          ...
          <Link href="/login" className="text-neutral hover:underline">
            Log in
          </Link>
        </p>
      </div>
